...
id_to_name = {'': '', '1': 'Muhammad', '2': "Kamolxon", '3': "Abubakir"}  # Shaxslar ro'yxati
    ...
    for (x, y, w, h) in faces:
        ...
        if accuracy < 100:
            ...
            if id not in id_to_last_seen:
                ...
                with open("C:\\Users\\Komol\\Desktop\\Python Project\\Project_For_WorkArea\\login_log.txt", "a") as file:
                                file.write(f"{id}: {soat}:{minute}da ishga keldi\n")
